...
fun main() {
    ...
    val mapOfName = mapOf<String,String>("name" to "ifnjgh" ,"age" to "20" ,"nationality" to "oiewfnjdgfj")//mapOf is also immutable for mutable use hashmap.
    println(mapOfName.get("age"))
    println(mapOfName.entries)
